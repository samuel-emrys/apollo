...
private:
    ...
    QVector<long long> m_volume; //consider changing to qt's datatypes

public:
    DataSeries();
    DataSeries(QVector<double> date, QVector<double> open, QVector<double> high, QVector<double> low, QVector<double> close, QVector<long long> vol);
    ...
    QVector<long long> getVol() { return this->m_volume; }
    ...
    void setVol(QVector<long long> _vol) { this->m_volume = _vol; }
